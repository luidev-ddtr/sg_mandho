...
import AnaliticsButton from '../partials/analytics/AnalyticsButton';
import AnalyticsButton from '../partials/analytics/AnalyticsButton';
function Analytics() {
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Analiticas y panel de control</h1>
              </div>
